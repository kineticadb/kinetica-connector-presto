        ...
        extends BaseJdbcClient
{
    ...
    @Inject
    public KineticaClient(BaseJdbcConfig config, ConnectionFactory connectionFactory, TypeManager typeManager)
    {
        ...
        this.aggregateFunctionRewriter = new AggregateFunctionRewriter(
                ...
                ImmutableSet.<AggregateFunctionRule>builder()
                        ...
                        .add(new ImplementSum(KineticaClient::toTypeHandle))
    ...
    {
        /*if (schemaName.equalsIgnoreCase("kinetica")) {
            return false;
        }*/
        switch (schemaName) {
            case "SYSTEM":
