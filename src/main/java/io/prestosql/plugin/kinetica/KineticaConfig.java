...
public class KineticaConfig
{
    ...
    @Config("kinetica.auto-reconnect")
    public KineticaConfig setAutoReconnect(boolean autoReconnect)
    {
    ...
    @Config("kinetica.max-reconnects")
    public KineticaConfig setMaxReconnects(int maxReconnects)
    {
    ...
    @Config("kinetica.connection-timeout")
    public KineticaConfig setConnectionTimeout(Duration connectionTimeout)
    {
    ...
    @Config("kinetica.jdbc.use-information-schema")
    @ConfigDescription("Value of useInformationSchema Kinetica JDBC driver connection property")
    public KineticaConfig setDriverUseInformationSchema(boolean driverUseInformationSchema)
    {
